...
#include "dx_vgui_controls/utilities.h"
...
public:
	...
	ColorPicker( vgui::Panel *parent, const char *pElementName, TextEntry *pTargetEntry );
	ColorPicker( vgui::Panel *parent, const char *pElementName, Panel *pActionsignalTarget );
	~ColorPicker();
...
private:
	...
	void UpdateAllVars( Panel *pIgnore = NULL );
