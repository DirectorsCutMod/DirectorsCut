<p align="center">
  <a href="https://github.com/KiwifruitDev/DirectorsCut">
    <img width=75% alt="Director's Cut logo" src="https://i.imgur.com/71ceAUU.png">
  </a>
  <br><br>
...
- [Director's Cut on Valve Developer Community](https://developer.valvesoftware.com/wiki/Director's_Cut)
...
- **Building Director's Cut:**
  ...
  - **Creating Visual Studio Solution:**
    - After cloning the repository, run `src/creategameprojects.bat` to create the Visual Studio solution.

  - **Building the Solution:**
    - Open `src/games.sln` in Visual Studio and build the solution.
