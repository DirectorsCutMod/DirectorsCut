...
For example, you might have the following file structure:
	...
	directorscut/custom/my_custom_stuff/   <<< This subfolder will be added as a search custom
	directorscut/custom/my_custom_stuff/models/custom_model.mdl
	directorscut/custom/my_custom_stuff/materials/custom_material.vmt
	directorscut/custom/my_custom_stuff/materials/vgui/custom_ui_thing.res
	directorscut/custom/some_mod.vpk       <<< This VPK will be added as a search custom
	directorscut/custom/another_mod.vpk    <<< This VPK will be added as a search custom
...
Note that the following directory structure is NOT correct:
	...
	directorscut/custom/models/my_model.mdl

That will add the directory "directorscut/custom/models" as a search path, in which case the
